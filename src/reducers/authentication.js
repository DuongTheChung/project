...
export default function reducer(state = initialState, action) {
  switch (action.type) {
    ...
    case 'AUTHENTICATION_SESSION_CHECK_SUCCESS': {
      ...
      newState.privatekey=action.json.privatekey;
      newState.publickey=action.json.publickey;
      newState.kcoin_actual_balance=action.json.kcoin_actual_balance;
      newState.kcoin_available_balances=action.json.kcoin_available_balances;
      newState.address=action.json.address;
      return newState;
    }
